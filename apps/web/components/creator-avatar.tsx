...
export function CreatorAvatar({ creatorId, withName = false }: { creatorId?: string | null; withName?: boolean }) {
  if (!creatorId)
    return (
...
function Customer({ customerId, withName }: { customerId: string; withName: boolean }) {
